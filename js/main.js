// js/main.js
// Carga de tasas (sacadas de localStorage o con default)
const rates = {
...
// Lógica de la calculadora y generación de mensaje WhatsApp
function calculateAll() {
  ...
  document.getElementById('mgReceived').textContent = 
    (amount * moneyGram).toFixed(2);
  document.getElementById('wuReceived').textContent = 
    (amount * westernUnion).toFixed(2);
  document.getElementById('riaReceived').textContent = 
    (amount * ria).toFixed(2);
